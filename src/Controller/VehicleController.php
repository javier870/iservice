...
class VehicleController extends AbstractController
{
     ...
     * @OA\Parameter(name="type", in="header", required=true, description="Only new/used options are allowed.",
     *         @OA\Schema(type="string", example="new"))
     * @OA\Parameter(name="msrp", in="header", required=true, description="Manufacturer Suggested Retail Price must be decimal(20,2), up to 2 decimal places.",
     *         @OA\Schema(type="number", example="8500.99"))
     * @OA\Parameter(name="year", in="header", required=true, description="Built year",
     *         @OA\Schema(type="integer", example="2022"))
     * @OA\Parameter(name="make", in="header", required=true, description="",
     *         @OA\Schema(type="string", example="Ford"))
     * @OA\Parameter(name="model", in="header", required=true, description="",
     *         @OA\Schema(type="string", example="F150"))
     * @OA\Parameter(name="miles", in="header", required=true, description="Miles in the Odometer",
     *         @OA\Schema(type="integer", example="35000"))
     * @OA\Parameter(name="vin", in="header", required=true, description="Vehicle Identification Number must be unique.",
     *         @OA\Schema(type="string", example="1FTEW1C58NKD33222"))
     * @OA\Parameter(name="deleted", in="header", required=true, description="Makes the vheicle (dis)appear from the list.",
     ...
     * @return Vehicle
     */
    private function getVehicle($id, ObjectManager $entityManager): Vehicle
    {
     ...
     *
     * @OA\Parameter(name="type", in="header", required=false, description="Only new/used options are allowed.",
     *         @OA\Schema(type="string", example="new"))
     * @OA\Parameter(name="msrp", in="header", required=false, description="Manufacturer Suggested Retail Price must be decimal(20,2), up to 2 decimal places.",
     *         @OA\Schema(type="number", example="8500.99"))
     * @OA\Parameter(name="year", in="header", required=false, description="Built year",
     *         @OA\Schema(type="integer", example="2022"))
     * @OA\Parameter(name="make", in="header", required=false, description="",
     *         @OA\Schema(type="string", example="Ford"))
     * @OA\Parameter(name="model", in="header", required=false, description="",
     *         @OA\Schema(type="string", example="F150"))
     * @OA\Parameter(name="miles", in="header", required=false, description="Miles in the Odometer",
     *         @OA\Schema(type="integer", example="35000"))
     * @OA\Parameter(name="vin", in="header", required=false, description="Vehicle Identification Number must be unique.",
     *         @OA\Schema(type="string", example="1FTEW1C58NKD33222"))
     * @OA\Parameter(name="deleted", in="header", required=false, description="Makes the vheicle (dis)appear from the list.",
     *         @OA\Schema(type="boolean", example="false"))
     *
     * @OA\Response(
     *     response=200,
    ...
    public function update(Request $request, int $id, ManagerRegistry $doctrine, ValidatorInterface $validator): JsonResponse
    {
        //retrieve the vehicle data from DB
        $entityManager = $doctrine->getManager();
        $vehicle = $this->getVehicle($id, $entityManager);
